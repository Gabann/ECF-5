...
public class SearchSuggestionServiceImpl implements SearchSuggestionService
{
	...
	public void loadSearchSuggestionToMap()
	{
		...
		while (true)
		{
			...
			{
				System.out.println(
						"Erreur : Impossible de se connecter à l'API de suggestion de recherche. Le serveur est peut-être hors ligne");
	...
	{
		System.out.println("constructAndAddKeywordCombination => jsonResponse : " + jsonResponse + "key : " + key + "attributeNames " +
				attributeNames);
		JSONArray jsonArray = parseJSONArray(jsonResponse, key);
